...
var E = { options: t({}, y), classNames: t({}, y.classNames), initialize: function(r2) {
  ...
  } }), e.DomEvent.disableClickPropagation(this.button), this.resetButton = s("button", this.classNames.resetButton, this.searchElement.form, { text: "×", "aria-label": this.options.clearSearchLabel, onClick: function() {
  ...
  try {
    ...
    var r2 = e3.target.value, n2 = t2.options.provider, o2 = function() {
      if (r2.length) return Promise.resolve(n2.search({ query: r2 })).then(function(e4) {
