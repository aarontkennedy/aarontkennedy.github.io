import {
  ...
  useMapEvent,
  useMapEvents
} from "./chunk-K4UD3WIC.js";
import {
  MapContainer
} from "./chunk-DLSEWM73.js";
import {
  LeafletProvider,
  addClassName,
...
var TileLayer = createTileLayerComponent(function createTileLayer({ url, ...options }, context) {
  const layer = new import_leaflet16.TileLayer(url, withPane(options, context));
...
var Tooltip = createOverlayComponent(function createTooltip(props, context) {
  const tooltip = new import_leaflet17.Tooltip(props, context.overlayContainer);
...
var VideoOverlay = createLayerComponent(function createVideoOverlay({ bounds, url, ...options }, ctx) {
  var _a;
  const overlay = new import_leaflet18.VideoOverlay(url, bounds, options);
...
var WMSTileLayer = createTileLayerComponent(function createWMSTileLayer({ eventHandlers: _eh, params = {}, url, ...options }, context) {
  const layer = new import_leaflet19.TileLayer.WMS(url, {
    ...params,
...
var ZoomControl = createControlComponent(function createZoomControl(props) {
  return new import_leaflet20.Control.Zoom(props);
});
export {
  AttributionControl,
  Circle,
